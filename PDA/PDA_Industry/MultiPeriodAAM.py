        ...
        for i in range(self._province_count):
            ...
            for t in range(1, self._period_count):
                if t-1 != 0:
                    ...
                    contribution = spaam_t_1_t.remx()[i] * spaam_t_1_t.emx_ratio()[i]
                    value += emx * contribution
            logging.error("value is %s"%value)
            result.append(value)
        return result
    def emx_t(self, t):
        '''
        ...
        for i in range(self._province_count):
            ...
            for t in range(1, self._period_count):
                if t-1 != 0:
                    ...
                    value += yct * contribution
            result.append(value)
        #result = [item/yct_sum for item in result]
        return result
...
if __name__ == "__main__":
    ...
    mpaam = Mpaam([dmus_2006, dmus_2007, dmus_2008, dmus_2009, dmus_2010, dmus_2011
                            , dmus_2012, dmus_2013, dmus_2014], '2006-2004')
    print(sum(mpaam.emx()))
    emx_total =mpaam.emx_t(8)
    print(emx_total)
